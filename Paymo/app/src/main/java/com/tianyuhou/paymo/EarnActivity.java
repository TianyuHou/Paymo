...
public class EarnActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_earn);
        ...
        startDateEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startdatepicker = DatePickerDialog.newInstance(EarnActivity.this, year, month, day);
        ...
        endDateEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                enddatepicker = DatePickerDialog.newInstance(EarnActivity.this, year, month, day);
        ...
        searchbtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(startY < endY || (startY == endY && startD<=endD)){
                    ...
                    db = new DBhelper(getApplicationContext());
                    try{
                        cost = db.getEarn(newStartdate,newEnddate);
                        setPieChart(cost,costpie);
                    }catch (Exception e){
                        e.printStackTrace();
                    }finally {
    ...
    private void setPieChart(ArrayList<Cost> cost,PieChart costpie){
        ...
        costpie.setCenterText("Total Earn \n\n"+total);
        costpie.setCenterTextColor(Color.rgb(211,47,47));
        ...
        costDataSet.setColors(ColorTemplate.JOYFUL_COLORS);
